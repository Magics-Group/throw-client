...
!else
    !searchparse /file "../../package.json" '"version": "' LIBRARIAN_VERSION '",'
!endif
!searchreplace LIBRARIAN_VERSION_CLEAN "${LIBRARIAN_VERSION}" "-" ".0"
!ifdef WIN_PATHS
...
VIAddVersionKey "ProductVersion" "${LIBRARIAN_VERSION}"
VIAddVersionKey "FileDescription" "${APP_NAME} ${LIBRARIAN_VERSION} Installer"
VIAddVersionKey "FileVersion" "${LIBRARIAN_VERSION}"
...
LangString desktopShortcut ${LANG_Catalan} "Drecera d'escriLIBRARIANori"
